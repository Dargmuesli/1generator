...
document.getElementById('translate').textContent = translate(document.getElementById('translate').textContent);
...
function removeTextAreaWhiteSpace() {
    ...
    input.value = input.value.replace(/^\s*|\s*$/gm, '');
    output.value = output.value.replace(/^\s*|\s*$/gm, '');
}
